...
import Moe.Domain.Bangumi.Episode (EpisodeNumber (..), GroupName (..))
...
testData =
  [ TestCase
      ...
      (Just (GroupName "Nekomoe kissaten"))
      (Just "1080P")
      [CHS, JPN],
    TestCase
      "With dash episode"
    ...
    TestCase
      ...
      (Just (GroupName "动漫国字幕组&LoliHouse"))
      (Just "1080P")
      [CHS, CHT],
    TestCase
      ...
      (Just (EpisodeNumber 1))
      (Just (GroupName "喵萌奶茶屋&LoliHouse"))
      (Just "1080P")
      [CHS, CHT, JPN],
    TestCase
      "Bracket episode"
    ...
    TestCase
      ...
      (Just (GroupName "DHR动研字幕组&KNA字幕组&动漫国字幕组"))
      (Just "720P")
      [CHT, JPN]
  ]
