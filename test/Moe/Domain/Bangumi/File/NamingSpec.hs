...
namingTests =
  [ testCase "regular episode S01E01" $ do
    ...
    testCase "MP4 extension" $ do
      let meta = BangumiMeta "Frieren" (Just 2023) Nothing
          file = BangumiFile meta (Episode (Regular 1 1)) (Video MP4) Nothing
